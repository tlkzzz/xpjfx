...
import com.tlkzzz.jeesite.common.security.shiro.session.SessionDAO;
...
import com.tlkzzz.jeesite.common.security.Digests;
import com.tlkzzz.jeesite.common.service.BaseService;
import com.tlkzzz.jeesite.common.service.ServiceException;
import com.tlkzzz.jeesite.common.utils.Encodes;
import com.tlkzzz.jeesite.common.web.Servlets;
import com.tlkzzz.jeesite.modules.sys.dao.MenuDao;
import com.tlkzzz.jeesite.modules.sys.dao.RoleDao;
import com.tlkzzz.jeesite.modules.sys.dao.UserDao;
...
import com.tlkzzz.jeesite.modules.sys.utils.LogUtils;
...
public class SystemService extends BaseService implements InitializingBean {
	...
	public Page<User> findUser(Page<User> page, User user) {
		...
		// 设置分页参数
		user.setPage(page);
	List<User> u=userDao.findList(user);
		// 执行分页查询
...
//		systemRealm.clearAllCachedAuthorizationInfo();
	...
	public static boolean printKeyLoadMessage(){
		...
		sb.append("\r\n======================================================================\r\n");
		sb.append("\r\n    欢迎使用 "+Global.getConfig("productName")+"  - Powered By https://tlkzzz.com\r\n");
		sb.append("\r\n======================================================================\r\n");
