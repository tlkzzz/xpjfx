 ...
 */
package com.tlkzzz.jeesite.modules.act.service.ext;
...
//		}
		...
		if (user != null) {
			getSystemService().deleteUser(new com.tlkzzz.jeesite.modules.sys.entity.User(user.getId()));
		}
	}
...
//		return getDbSqlSession().selectList("selectGroupsByUserId", userId);
		...
		for (Role role : getSystemService().findRole(new Role(new com.tlkzzz.jeesite.modules.sys.entity.User(null, userId)))){
