...
<body>
	<ul class="nav nav-tabs">
        ...
        <li class="active"><a href="${ctx}/cw/fReceipt/ybform">一般费用单</a></li>
       <shiro:hasPermission name="cw:fReceipt:edit"><li><a href="${ctx}/cw/fReceipt/qtform">其他费用单</a></li></shiro:hasPermission>
    	</ul><br/>
