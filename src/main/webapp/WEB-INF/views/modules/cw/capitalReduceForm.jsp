...
<ul class="nav nav-tabs">
    ...
    <li class="active"><a href="${ctx}/cw/fTransferAccount/capitalReduceForm?id=${fTransferAccount.id}">资金减少<shiro:hasPermission name="cw:fTransferAccount:edit">${not empty fTransferAccount.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cw:fTransferAccount:edit">查看</shiro:lacksPermission></a></li>
</ul><br/>
