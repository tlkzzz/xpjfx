...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/report/cHgoods/kcInquiry">库存明细列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="cHgoods" action="${ctx}/report/cHgoods/kcInquiry" method="post" class="breadcrumb form-search">
