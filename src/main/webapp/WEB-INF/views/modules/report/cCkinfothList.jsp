...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ck/cCkinfo/listInquiret">退货单列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="cCkinfo" action="${ctx}/ck/cCkinfo/listInquiret" method="post" class="breadcrumb form-search">
