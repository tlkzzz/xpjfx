...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/ck/cCkinfo/library">出库录单</a></li>
	...
	<form:form id="inputForm" modelAttribute="cCkinfo" action="${ctx}/ck/cCkinfo/saveLibrary" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">客户：</label>
			<div class="controls">
				<form:select path="store.id" class="required">
