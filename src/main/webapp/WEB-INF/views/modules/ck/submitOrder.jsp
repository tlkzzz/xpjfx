...
<body>
	...
	<form:form id="inputForm" modelAttribute="fReceipt" action="${ctx}/cw/fReceipt/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="subjectCode" name="subjectCode.id" value="${fReceipt.subjectCode.id}" labelName="subjectCode.kmname" labelValue="${fReceipt.subjectCode.kmname}"
								title="科目编码" url="/ck/cKm/treeData" cssClass="" allowClear="true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="je" htmlEscape="false" <c:if test="${toDiscount}">readonly="true"</c:if> maxlength="1" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
