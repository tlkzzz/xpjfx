...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${areaList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.parent?tpl.parent.id:0}', name:"${tpl.name}", url:"${ctx}/ck/cGoods/list?gclass.id=${tpl.id}", target:"cGoodsMainFrame"},
		            </c:forEach>];
