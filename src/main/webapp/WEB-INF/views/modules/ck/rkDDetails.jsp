            ...
            <div id="divbody1" class="panel-body">
                <div id="Anthem_pnlEdit__"><div id="pnlEdit">
                    ...
                    <table style="font-size: 13px; height: 100%; width: 100%;">
                        <tbody><tr>
                            <td style="width: 80px">入库编号：
                            </td>
                            <td style="width: 200px;" align="left">
                                <span id="lblRKDH">${cRkckddinfo.ddbh}</span>
                            </td>
                            <td style="width: 80px">入库仓库：
                            </td>
                            <td align="left" style="width: 200px;">
                                <span id="lblRKMC">${cRkckddinfo.cHouse.name}</span>
                            </td>
                        ...
                        <tr>
                            ...
                            <td align="left">
                                <span id="lblHJJE">${cRkckddinfo.htje}</span>
                            </td>
                        </tr>
                        <tr>
                            <td>入库类型：
                            ...
                            <td align="left">
                                <span id="lblRKLX">${fns:getDictLabel(cRkckddinfo.state, "ckState", "")}</span>
                            </td>
                            <td>入库日期：
                            </td>
                            <td align="left">
                        ...
                        <table class="lk-table003 table-hover" cellspacing="0" rules="all" border="1" id="grid" style="border-collapse:collapse;">
                            ...
                            <c:forEach items="${cdList}" varStatus="status" var="cd">
                                <tr>
                                    ...
                                    <td align="center"></td>
                                    <td align="right">${cd.type}</td>
                                    <td align="right">
                                        <c:if test="${fn:length(cd.goods.spec.arrSpec)>2}">${cd.goods.spec.arrSpec[0]*cd.goods.spec.arrSpec[1]*cd.goods.spec.arrSpec[2]*cd.je}</c:if>
                                        <c:if test="${fn:length(cd.goods.spec.arrSpec)<=2}">${cd.goods.spec.arrSpec[0]*cd.goods.spec.arrSpec[1]*cd.je}</c:if>
                                    </td>
