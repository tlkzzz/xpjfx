...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ck/cDdinfo/cstore">仓库利润排行</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="cDdinfo" action="${ctx}/ck/cDdinfo/cstore" method="post" class="breadcrumb form-search">
