...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/ck/cCkinfo/scrapped">报废录单</a></li>
		<shiro:hasPermission name="ck:cCkinfo:edit"><li><a href="${ctx}/ck/cCkinfo/returnOfGoods">退货录单</a></li></shiro:hasPermission>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cCkinfo" action="${ctx}/ck/cCkinfo/saveScrapped" method="post" class="form-horizontal">
		<form:hidden path="id"/>
