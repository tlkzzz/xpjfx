...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var zNodes=[
		            <c:forEach items="${cSClassList}" var="tpl">{id:'${tpl.id}', pId:'${not empty tpl.parent?tpl.parent.id:0}', name:"${tpl.name}", url:"${ctx}/ck/cStore/list?id=${tpl.id}", target:"cStoreMainFrame"},
		            </c:forEach>];
...
<body>
	<div class="accordion-group">
	    <div class="accordion-heading">
	    	<a class="accordion-toggle">客户分类列表<i class="icon-refresh pull-right" onclick="refreshTree();"></i></a>
	    </div>
