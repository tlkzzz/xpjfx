...
<body>
	<ul class="nav nav-tabs">
		<li class="active"><a href="${ctx}/ck/cRkinfo/">入库记录列表</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="cRkinfo" action="${ctx}/ck/cRkinfo/" method="post" class="breadcrumb form-search">
