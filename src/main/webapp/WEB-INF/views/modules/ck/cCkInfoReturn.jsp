...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/ck/cCkinfo/returnOfGoods">退货录单</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cCkinfo" action="${ctx}/ck/cCkinfo/saveReturnOfGoods" method="post" class="form-horizontal">
		<form:hidden path="id"/>
